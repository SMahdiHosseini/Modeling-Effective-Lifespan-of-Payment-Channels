...
SEED=10
N_NODES=10
CHANNEL_EXISTANCE_PROB=$(python -c "print(0.95)")
...
n_channels=$(python3 network_generator.py $SEED $N_NODES $CHANNEL_EXISTANCE_PROB $AVERAGE_CAPACITY $AVERAGE_PAYMENT_AMOUNT $MRATES_FILE $FEE_BASE $FEE_PROPORTIONAL $MIN_HTLC $TIMELOCK)
